...
#define unitLabelH 40*ScaleValueY
#import "TextView.h"
...
{
    UILabel *label = [[UILabel alloc]initWithFrame:CGRectMake(20*ScaleValueX, 0, KScreenWidth, learningLabelH)];
    label.text = title;
    label.contentMode = UIViewContentModeLeft;
    label.textColor = textColor;
    label.font = [UIFont systemFontOfSize:17*ScaleValueY];
    return label;
}
...
- (void)setModel:(NDDetailModel *)model
{
    ...
    UIImageView *imgView = [[UIImageView alloc]initWithFrame:CGRectMake(0, 40*ScaleValueY, KScreenWidth, learningViewH-learningLabelH)];
